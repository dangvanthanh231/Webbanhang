...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=MSI\\SQLEXPRESS;Database=WebsiteBanHang;Trusted_Connection=True;TrustServerCertificate=true;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Blog>(entity =>
        {
            entity.HasKey(e => e.IdBlog).HasName("PK__BLOG__75519326D3399DD8");
        ...
        {
            entity.HasKey(e => e.IdCart).HasName("PK__CART__7A1680A55DEBD855");
        ...
        {
            entity.HasKey(e => e.IdCd).HasName("PK__CART_DET__8B622F8FB69E4F9B");
        ...
        {
            entity.HasKey(e => e.IdCat).HasName("PK__CATOLOGY__2BF8FA1C34066F81");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__MENU__4728FC6068C3B268");
        ...
        {
            entity.HasKey(e => e.IdPro).HasName("PK__PRODUCTS__20AF98FD2A4EDE2D");
        ...
        {
            entity.HasKey(e => e.IdSlide).HasName("PK__SLIDER__22D1BB10C4A48BE5");
        ...
        {
            entity.HasKey(e => e.IdUsers).HasName("PK__USERS__1DDB35C37A2EADEE");
